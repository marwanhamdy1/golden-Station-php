...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create New Visit</h1>
        </div>
        <p class="text-gray-600">Record a new vendor visit with all details</p>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <select id="visit_status"
                            ...
                            <option value="visited" {{ old('visit_status') == 'visited' ? 'selected' : '' }}>Visited</option>
                            <option value="closed" {{ old('visit_status') == 'closed' ? 'selected' : '' }}>Closed</option>
                            <option value="not_found" {{ old('visit_status') == 'not_found' ? 'selected' : '' }}>Not Found</option>
                            <option value="refused" {{ old('visit_status') == 'refused' ? 'selected' : '' }}>Refused</option>
                        </select>
                        @error('visit_status')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="vendor_rating"
                            ...
                            <option value="very_interested" {{ old('vendor_rating') == 'very_interested' ? 'selected' : '' }}>Very Interested</option>
                            <option value="hesitant" {{ old('vendor_rating') == 'hesitant' ? 'selected' : '' }}>Hesitant</option>
                            <option value="refused" {{ old('vendor_rating') == 'refused' ? 'selected' : '' }}>Refused</option>
                            <option value="inappropriate" {{ old('vendor_rating') == 'inappropriate' ? 'selected' : '' }}>Inappropriate</option>
                        </select>
                        @error('vendor_rating')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="space-y-6 mb-8">
                    <div>
                        ...
                        <textarea id="notes"
                                  ...
                                  placeholder="General notes about the visit">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="agent_notes"
                                  ...
                                  placeholder="Notes that will be visible to the vendor">{{ old('agent_notes') }}</textarea>
                        @error('agent_notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="internal_notes"
                                  ...
                                  placeholder="Internal notes for team reference">{{ old('internal_notes') }}</textarea>
