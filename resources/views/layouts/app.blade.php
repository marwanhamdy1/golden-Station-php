...
<body class="bg-gray-50">
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white shadow-lg min-h-screen">
            <div class="p-4">
                <nav class="space-y-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-blue-50 text-primary' : '' }}">
                        <i class="fas fa-tachometer-alt mr-3"></i>
                        Dashboard
                    </a>
                    <a href="{{ route('agents.index') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->routeIs('agents.*') ? 'bg-blue-50 text-primary' : '' }}" id="agents-link">
                        <i class="fas fa-users mr-3"></i>
                        Agents
                    </a>
                    <a href="{{ route('vendors.index') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->routeIs('vendors.*') ? 'bg-blue-50 text-primary' : '' }}" id="vendors-link">
                        <i class="fas fa-store mr-3"></i>
                        Vendors
                    </a>
                    <a href="{{ route('branches.index') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->routeIs('branches.*') ? 'bg-blue-50 text-primary' : '' }}" id="branches-link">
